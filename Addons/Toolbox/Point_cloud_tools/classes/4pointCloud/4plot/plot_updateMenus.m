...
for i = 1:numel(hFig.UserData.PC)
    ...
    %   2024-01-23 Martin   sometimes it goes wrong, and adjus as this will
    %                       be more robost.
    temp_1 = hFig.UserData.PC{i}.label;
    temp_2 = hFig.UserData.PC{i}.U;
    % disp(temp_2);
    try temp_3 = temp_2.percentOfVisiblePoints;
    catch ME
        pause(1);
        temp_2 = hFig.UserData.PC{i}.U;
        try temp_3 = temp_2.percentOfVisiblePoints;
    ...
    temp_4 = sprintf('%s (%.1f%%)', temp_1, temp_3);
    hFig.UserData.PC{i}.U.hMenu.Label = temp_4;
    %   2024-01-23 Martin end
    % Visible
...
% Color
% save labels of parents for comparison
for i = 1:numel(parent2search4Color)
    parentLabel{i} = parent2search4Color{i}.Label; 
end 
